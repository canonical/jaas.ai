const canonicalGlobalNav = (function (a) {
  ...
  function c(a, n, t) {
    for (let l = 0; l < a.length; l += 1) n.call(t, l, a[l]);
  }
  function p(a) {
  ...
  return (
    (a.createNav = function (a) {
      const n = arguments.length > 0 && void 0 !== a ? a : {};
        const t = n.maxWidth;
        const l = void 0 === t ? '68rem' : t;
        const e = n.hiring;
        const o = void 0 !== e && e;
      console.log(
      ...
      const i = p(
        ...
        const r = p('<div id="canonical-global-nav" class="global-nav" role="complementary"></div>');
        const s = p('<div class="global-nav__overlay"></div>');
        const d = p(
              ...
              (function (a) {
                ...
                const l = i
                    .map(function (a, n) {
                      ...
                      let l = '<li class="global-nav__matrix-item">\n          <a class="global-nav__link" href='
                        .concat(
                          a.url,
                        ...
                        .concat(t, '\n          </div>\n        </li>');
                      if (n === i.length - 1)
                        for (let e = (2 * i.length) % 3, o = 0; o < e; o += 1)
                          l +=
                  ...
                  const e = r
                    .map(function (a, n) {
                      ...
                      let l = '<li class="global-nav__matrix-item">\n          <div class="global-nav__matrix-content">\n            <h4 class="global-nav__matrix-title"><a class="global-nav__link" href='
                        ...
                        .concat(t, '\n          </div>\n        </li>');
                      if (n === r.length - 1)
                        for (let e = (2 * r.length) % 3, o = 0; o < e; o += 1)
                          l +=
                            '<li class="global-nav__matrix-item">\n              &nbsp;\n            </li>';
                      return l;
                    })
      ...
      document.body.insertBefore(r, document.body.firstElementChild),
        ...
        r.appendChild(s),
        (function (a, l) {
          const t = l.querySelectorAll('.global-nav__header-link.has-dropdown');
            const e = l.querySelector('.global-nav__dropdown');
            const o = l.querySelectorAll('.global-nav__dropdown-content');
            const n = l.querySelectorAll('.global-nav__expanding-row');
            const i = l.querySelector('.global-nav__overlay');
          ...
          function g(a) {
            const n = a.querySelector('.global-nav__header-link-anchor').getAttribute('href');
              const t = l.querySelector(n);

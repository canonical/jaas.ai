var canonicalGlobalNav = (function(a) {
    ...
    flagships: [
      {
        ...
        description:
          'The fastest growing secure enterprise Linux for servers, desktops, clouds, developers and things.'
      },
      {
        title: 'Snapcraft',
  ...
  function c(a, n, l) {
    for (var t = 0; t < a.length; t += 1) n.call(l, t, a[t]);
  }
  function p(a) {
  ...
  return (
    (a.createNav = function(a) {
              ...
              (function(a) {
                ...
                var t = i
                    .map(function(a, n) {
                      var l = '';
                      a.links &&
                        (l = '<ul class="global-nav__inline-list">\n          '.concat(
                          s(a),
                          '\n        <ul>'
                        ));
                      var t = '<li class="global-nav__matrix-item">\n          <a class="global-nav__link" href='
                        .concat(
                          a.url,
                  ...
                  e = r
                    .map(function(a, n) {
                      var l = '';
                      a.links &&
                        (l = '<ul class="global-nav__inline-list u-no-padding--left">\n          '.concat(
                          s(a),
                          '\n        <ul>'
                        ));
      ...
      document.body.insertBefore(r, document.body.firstElementChild),
        ...
        r.appendChild(s),
        (function(a, t) {
          var l = t.querySelectorAll('.global-nav__header-link.has-dropdown'),
            e = t.querySelector('.global-nav__dropdown'),
            o = t.querySelectorAll('.global-nav__dropdown-content'),
            n = t.querySelectorAll('.global-nav__expanding-row'),
            i = t.querySelector('.global-nav__overlay'),
          ...
          function g(a) {
            ...
            a.classList.add('is-selected'),
              c(o, function(a, n) {
                return n !== l && n.classList.add('u-hide');
              }),

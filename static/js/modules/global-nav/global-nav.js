  ...
  return (
    (a.createNav = function() {
      ...
      var o,
        ...
        r = C('<div id="canonical-global-nav" class="global-nav" role="complementary"></div>'),
        g = C('<div class="global-nav__overlay"></div>'),
        s = '',
        d = '';
      t &&
        ((d = [
            ...
            (b = v
              .map(function(a, l) {
                var n =
                  ...
                  '</p>\n          </div>\n        </li>';
                if (l === v.length - 1)
                  for (var e = (2 * v.length) % 3, t = 0; t < e; t += 1)
                    n +=
                      '<li class="global-nav__matrix-item">\n              &nbsp;\n            </li>';
                return n;
              })
            ...
            (u = h
              .map(function(a, l) {
                var n =
                  ...
                  '</p>\n          </div>\n        </li>';
                if (l === h.length - 1)
                  for (var e = (2 * h.length) % 3, t = 0; t < e; t += 1)
                    n +=
                      '<li class="global-nav__matrix-item">\n              &nbsp;\n            </li>';
                return n;
              })
      ...
      document.body.insertBefore(r, document.body.firstElementChild),
        ...
        r.appendChild(g),
        (function(a, e) {
          var n = e.querySelectorAll('.global-nav__header-link'),
            t = e.querySelector('.global-nav__dropdown'),
            o = e.querySelectorAll('.global-nav__dropdown-content'),
            l = e.querySelectorAll('.global-nav__expanding-row'),
            i = e.querySelector('.global-nav__overlay'),
          ...
          function d(a) {
            var l = a.querySelector('.global-nav__header-link-anchor').getAttribute('href'),
              n = e.querySelector(l);
            a.classList.add('is-selected'),
              o.forEach(function(a) {
                return a !== n && a.classList.add('u-hide');
              }),
              n.classList.remove('u-hide'),
                ...
                t.classList.contains('show-content')
                  ? l.classList.contains('is-selected')
                    ...
                    : (n.forEach(function(a) {
                      ...
                      d(l))
                  : (t.classList.add('show-content'), d(l));
            });
          }),

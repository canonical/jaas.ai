!(function(a) {
  ...
  (n.m = a),
    ...
    (n.t = function(a, l) {
      if ((1 & l && (a = n(a)), 8 & l)) return a;
      if (4 & l && 'object' == typeof a && a && a.__esModule) return a;
    ...
    !(function(a) {
      ...
      !(function(a) {
        if ('undefined' != typeof window) {
          ...
          l.setAttribute('type', 'text/css'), (l.innerHTML = a), document.head.appendChild(l);
        }
      })(
      ...
      var l = {
          ...
          resources: [
            {title: 'Webinars', url: 'https://blog.ubuntu.com/?category=webinars#posts-list'},
            {title: 'Tutorials', url: 'https://tutorials.ubuntu.com/'},
            {title: 'Videos', url: 'https://blog.ubuntu.com/?category=videos#posts-list'},
            {
              title: 'Case studies',
      ...
      function e(a) {
        ...
        return (l.innerHTML = a), l.childNodes[0];
      }
      (a.createNav = function() {
        ...
        var g,
          s = e('<div id="canonical-global-nav" class="global-nav"></div>'),
          d = e('<div class="global-nav__overlay"></div>'),
          c = '',
          v = '';
        r &&
          ((v = [
              ...
              (f = p
                .map(function(a, l) {
                  var n =
                    ...
                    '</p>\n          </div>\n        </li>';
                  if (l === p.length - 1)
                    for (var e = (2 * p.length) % 3, t = 0; t < e; t += 1)
                      n +=
                        '<li class="global-nav__matrix-item">\n              &nbsp;\n            </li>';
                  return n;
                })
              ...
              (w = m
                .map(function(a, l) {
                  var n =
                    ...
                    '</p>\n          </div>\n        </li>';
                  if (l === m.length - 1)
                    for (var e = (2 * m.length) % 3, t = 0; t < e; t += 1)
                      n +=
                        '<li class="global-nav__matrix-item">\n              &nbsp;\n            </li>';
                  return n;
                })
        ...
        document.body.insertBefore(s, document.body.firstElementChild),
          s.appendChild(x),
          s.appendChild(F),
          s.appendChild(d),
          (function(a, l) {
            var n = l.querySelectorAll('.global-nav__header-link'),
              e = l.querySelector('.global-nav__dropdown'),
              t = l.querySelectorAll('.global-nav__dropdown-content'),
              o = l.querySelectorAll('.global-nav__expanding-row'),
              i = l.querySelector('.global-nav__overlay'),
              r = window.innerWidth < 900;
            function g() {
            ...
            function d(a) {
              ...
              a.classList.add('is-selected'),
                t.forEach(function(a) {
                  return a !== e && a.classList.add('u-hide');
                }),
                  ...
                  e.classList.contains('show-content')
                    ? a.classList.contains('is-selected')
                      ...
                      : (n.forEach(function(a) {
                        ...
                        d(a))
                    : (e.classList.add('show-content'), d(a));
              });
            }),
